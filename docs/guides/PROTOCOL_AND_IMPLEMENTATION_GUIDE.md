...
| **7173** | 4214 + 4260 | 10 | **逐笔/超级盘口配套短查询**。`0-0`/`-1` 非历史区间，与 7169 成组触发。"逐笔委托"标签**无响应内容证据**，降级为「配套短查询」 | ⚠️ 触发时机确认，业务待破译 |
| **7174** | 4214 + 4260 | 10 | 同 7173，与 7173 **成对出现**。两轮抓包均复现，**非偶发** | ⚠️ 同上 |
| **4096** | 4214 + 4260 | 4214: 7,49,12,18,75,10,6,66 / 4260: 20+字段 | **分笔 tick（类比）**。双形态：4214 夹在逐笔翻页中间触发，4260 打开超级盘口时触发。两通道 DataType 差异大，业务是否相同未证实 | ⚠️ 类比合理，未证实 |
...
> 与沪市 603118 对照可攻字段表破译。详见 `HANDOFF_KANPAN_CAPTURE_20260805.md` §H。
