...
```
bar_start = (目标日期 - date(1849,4,6)).days × 2048 + 606
...
**关键：hexin 对深市个股实发的是「伴随代码 + 目标票」混合请求**，常见
`399002+000938`。2026-07-28 已证明 399002 可替换为 000001，返回的确是 000001
对应交易日的数据；它不是服务器硬编码依赖。服务器能接受的最小子帧形态仍待在正确
L2 连接上做主动 A/B。
