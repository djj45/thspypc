...
# 603118/688825/688981）：dt27(买方未匹配量) 和 dt33(卖方未匹配量) 在「该方向无
# 未匹配委托」时，字节流写的是 0x80000000（=ths_float 的除法标记位 + 尾数 0），
...
# 受哨兵语义影响的字段（dt27 买方未匹配 / dt33 卖方未匹配）。dt10/dt49 实测从不带哨兵。
